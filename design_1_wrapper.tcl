...
namespace eval ::optrace {
  variable script "Z:/eece4632/FFT/FFT.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir Z:/eece4632/FFT/FFT.cache/wt [current_project]
  set_property parent.project_path Z:/eece4632/FFT/FFT.xpr [current_project]
  set_property ip_repo_paths {
  c:/Users/snataraj/Using_IP_with_IPI/lab1/hls_designs/be_vhls_prj/IPXACTExport/impl/ip
  C:/Users/snataraj/Using_IP_with_IPI/lab1/hls_designs/fe_vhls_prj/IPXACTExport/impl/ip
} [current_project]
  update_ip_catalog
  set_property ip_output_repo Z:/eece4632/FFT/FFT.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet Z:/eece4632/FFT/FFT.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files Z:/eece4632/FFT/FFT.srcs/sources_1/bd/design_1/design_1.bd
